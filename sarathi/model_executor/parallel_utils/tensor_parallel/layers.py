...
class VocabParallelEmbedding(torch.nn.Module):
    ...
    def __init__(self, num_embeddings: int, embedding_dim: int, *,
        ...
        self.sparse = False
        self._weight = None
        self.tensor_model_parallel_size = get_tensor_model_parallel_world_size() if world_size is None else world_size
...
class ColumnParallelLinear(torch.nn.Module):
    ...
    def __init__(self, input_size, output_size, *,
        ...
        self._communication_timer = CudaTimer(communication_metric_name, layer_id=layer_id)
