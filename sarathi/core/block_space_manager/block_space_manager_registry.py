...
from sarathi.core.block_space_manager.deadline_block_space_manager import (
    DeadlineBlockSpaceManager,
)
...
BlockSpaceManagerRegistry.register(SchedulerType.DEADLINE, DeadlineBlockSpaceManager)
