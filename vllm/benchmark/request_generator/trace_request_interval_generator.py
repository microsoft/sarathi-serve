...
from vllm.benchmark.request_generator.base_request_interval_generator import (
...
class TraceRequestIntervalGenerator(BaseRequestIntervalGenerator):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._trace_df["arrival_time"] = pd.to_datetime(
        ...
        self._trace_df["arrival_time"] = (
            self._trace_df["arrival_time"] -
            self._trace_df["arrival_time"].min()) // pd.Timedelta("1s")
        ...
        self._trace_df["inter_request_time"] = self._trace_df[
            "arrival_time"].diff()
    ...
    def get_next_inter_request_time(self) -> float:
        ...
        inter_request_time = self._trace_df.iloc[
            self._next_request_idx]["inter_request_time"]
        self._next_request_idx += 1
