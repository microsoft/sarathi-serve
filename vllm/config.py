...
class ModelConfig:
    ...
    def __init__(
        ...
        skip_hidden_layers: Optional[bool] = False,
    ) -> None:
        self.model = model
        ...
        self.skip_hidden_layers = skip_hidden_layers
...
class MetricsConfig:
    ...
    def __init__(self, write_metrics: bool, output_dir: str, subsamples: int,
        ...
        self.save_table_to_wandb = save_table_to_wandb
