...
class OperationMetrics(enum.Enum):
    ...
    ATTN_KV_CACHE_SWAP = "attn_kv_cache_swap"
...
class CpuOperationMetrics(enum.Enum):
    SCHEDULE = "schedule"
    SAMPLER_LAUNCH = "sample_launch"
    SAMPLER_E2E = "sample_e2e"
    PREPARE_INPUTS_LAUNCH = "prepare_inputs_launch"
    PREPARE_INPUTS_E2E = "prepare_inputs_e2e"
    MODEL_EXECUTION_LAUNCH = "model_execution_launch"
...
class HighLevelCudaOperationMetrics(enum.Enum):
    ...
    PREPARE_INPUTS_CUDA = "prepare_inputs_cuda"
...
class SequenceMetricsHistogram(enum.Enum):
    ...
    REQUEST_NUM_SWAPS = "request_num_swaps"
