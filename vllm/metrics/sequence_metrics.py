...
class SequenceMetrics:
    ...
    def __init__(self, id: int, arrived_at: float, num_prompt_tokens: int):
        ...
        self._model_execution_time: float = 0.0
    ...
    def e2e_time_normalized(self) -> Optional[float]:
        return self.e2e_time / self._num_output_tokens if self.e2e_time else None
    ...
    def execution_time_normalized(self) -> float:
        return self._execution_time / self._num_output_tokens
    ...
    def model_execution_time_normalized(self) -> float:
        return self._model_execution_time / self._num_output_tokens
